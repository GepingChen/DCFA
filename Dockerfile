...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    DCFA_WEBSITE_GEMINI_CONFIG_FILE=/app/evaluation/configs/website_demo_gemini_v2.json \
...
COPY evaluation/configs/website_demo_gemini_v2.json ./evaluation/configs/website_demo_gemini_v2.json
COPY src ./src
